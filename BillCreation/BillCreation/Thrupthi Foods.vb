...
Public Class Thrupthi_Foods
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BillCreation.Thrupthi Foods.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Sample1() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedThrupthi_Foods
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Thrupthi_Foods = New Thrupthi_Foods()
        rpt.Site = Me.Site
        Return rpt
    End Function
