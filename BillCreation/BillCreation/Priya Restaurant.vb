...
Public Class Priya_Restaurant
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BillCreation.Priya Restaurant.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPriya_Restaurant
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Priya_Restaurant = New Priya_Restaurant()
        rpt.Site = Me.Site
        Return rpt
    End Function
