...
Public Class Skydeck_Chicago
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "BillCreation.Skydeck Chicago.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSkydeck_Chicago
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Skydeck_Chicago = New Skydeck_Chicago()
        rpt.Site = Me.Site
        Return rpt
    End Function
